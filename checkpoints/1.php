...
/* Update box color based on selected option */
#assessmentIndicator.ok {
    background-color: green;
}

#assessmentIndicator.not-ok {
    background-color: yellow;
}

#assessmentIndicator.to-be-fixed {
    background-color: red;
}

#assessmentIndicator.not-applicable {
...
<body>
    ...
    <div class="checkpoint-form">
        <form id="checkpointForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
            <!-- Set default value for the question box -->
            <input type="text" style="background-color: #00008b; color: white;" id="question1" name="question1" required placeholder="Carrier Structure" value="Carrier Structure">
<div class="assessment-container">
  
    <div class="assessment-container">
    <label for="assessment1">Assessment:</label>
    <select id="assessment1" name="assessment1" required onchange="updateAssessmentColor()">
...
function updateAssessmentColor() {
    ...
    var photoIndicator = document.getElementById('photoIndicator');

    switch (selectedOption.value) {
        case 'ok':
            photoIndicator.style.backgroundImage = "url('green.jpg')";
            break;
        case 'not ok':
            photoIndicator.style.backgroundImage = "url('yellow.jpg')";
            break;
        case 'to be fixed':
            photoIndicator.style.backgroundImage = "url('red.jpg')";
            break;
        case 'not applicable':
            photoIndicator.style.backgroundImage = "url('grey.jpg')";
            break;
        default:
            // Default image or no image
            photoIndicator.style.backgroundImage = "none";
            break;
    }
}
