...
<body>
    ...
    <div class="checkpoint-form">
        <form id="checkpointForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
            <input type="text" style="background-color: #00008b; color: white;" id="question1" name="question1" required placeholder="pressure gauge" value="pressure gauge" required placeholder="pressure gauge" value="pressure gauge" required placeholder="Question">
