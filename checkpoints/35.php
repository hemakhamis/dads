...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Write the complete form data (inczluding image data) to the text file
...
<body>
    ...
    <div class="checkpoint-form">
        <form id="checkpointForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
            <input type="text" style="background-color: #00008b; color: white;" id="question1" name="question1" required placeholder="anti-tow block" value="anti-tow block" required placeholder="Question">
