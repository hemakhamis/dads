...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $formData = "Any Retrofitted Fuel Tanks:\n" .
...
<body>
    ...
    <div class="checkpoint-form">
        <form id="checkpointForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
            <input type="text" style="background-color: #00008b; color: white;" id="question1" name="question1" required placeholder="Any Retrofitted Fuel Tanks" value="Any Retrofitted Fuel Tanks" required placeholder="Any Retrofitted Fuel Tanks" value="Any Retrofitted Fuel Tanks" required placeholder="Question">
