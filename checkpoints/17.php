...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $formData = "slewing gear and beaning:\n" .
...
<body>
    ...
    <div class="checkpoint-form">
        <form id="checkpointForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
           <input type="text" style="background-color: #00008b; color: white;" id="question1" name="question1" required placeholder="slewing gear and beaning" value="slewing gear and beaning" required placeholder="slewing gear and beaning" value="slewing gear and beaning" required placeholder="Question">
