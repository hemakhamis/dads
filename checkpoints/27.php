...
/* Color styles for assessment options */
#assessment1 option[value="ok"] {
    background-color: green;
}

#assessment1 option[value="not ok"] {
    background-color: yellow;
}

#assessment1 option[value="to be fixed"] {
    background-color: red;
}

#assessment1 option[value="not applicable"] {
    background-color: grey;
}

/* Selected option color */
#assessment1 option:checked {
    color: white;
}
...
<body>
    ...
    <div class="checkpoint-form">
        <form id="checkpointForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
            <input type="text" style="background-color: #00008b; color: white;" id="question1" name="question1" required placeholder="brake" value="brake" required placeholder="brake" value="brake" required placeholder="Question">
